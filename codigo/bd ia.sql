...
('24','Salidas laborales MMO','Las salidas laborales para los graduados de esta orientación son variadas. Pueden desempeñarse como supervisores de obras en estudios de arquitectura, trabajar en empresas constructoras liderando proyectos o establecerse como profesionales independientes en el ámbito de la construcción.<br>🔹Presione 1 para volver al menu.',0,true),
('25','Materias MMO','Entre las materias destacadas en esta orientación se incluyen Planificación de Obras, que aborda la elaboración de cronogramas y presupuestos, Control de Costos, centrada en la gestión eficiente de los recursos financieros, y Gestión de Proyectos de Construcción, que prepara a los estudiantes para liderar proyectos desde su concepción hasta su finalización.<br>🔹Presione 1 para volver al menu.',0,true),
-- electromecanica
('15','Electromecanica','La orientación en Electromecánica de nuestra escuela tiene como objetivo formar profesionales capacitados en la integración de sistemas eléctricos y mecánicos. A lo largo de su formación, los estudiantes adquieren habilidades en el mantenimiento, reparación y diseño de sistemas electromecánicos. <br>¿Te interesa algo de esto?: <br>26🔹Salidas laborales electromecanica. <br>27🔹Materias electromecanica.',0,true),
('26','Salidas laborales electromecanica','Las salidas laborales para los graduados de esta orientación son diversas, abarcando la industria manufacturera, la automatización industrial y el mantenimiento de maquinaria. Los profesionales pueden desempeñarse como técnicos especializados en el área electromecánica, brindando soluciones a problemas complejos en sistemas integrados.<br>🔹Presione 1 para volver al menu.',0,true),
('27','Materias electromecanica','Entre las materias destacadas en esta orientación se incluyen Control Automático, que explora técnicas para la automatización de procesos, Máquinas y Equipos Eléctricos, que se centra en el funcionamiento de dispositivos electromecánicos, y Sistemas Hidráulicos y Neumáticos, que aborda la aplicación de fluidos en sistemas mecánicos.<br>🔹Presione 1 para volver al menu.',0,true),
-- preguntas corrientes
('como estas','Como estas','yo estoy bien,¿Y tu?, recuerda que en el rincon de sugerencias puedes ver la opinion de otros alumnos/as.<br>🔹Presiona 1 para volver al menu.',0,true),
('buenos dias','Buenos dias','Buen dia a ti tambien, espero que tengas un excelente dia.<br>🔹Presione 1 para volver al menu.',0,true),
('adios','Adios','¡nos vemos!',0,true),
('gracias','Gracias','Gracias a ti por elegirme. <br>🔹Presiona 1 para volver al menu.',0,true),
...
('47','Baños','Los baños de hombres estan en la planta baja, entre la escaleras y el ascensor, otro esta en el segundo piso en frente de preceptoria, otro esta al fondo del zoom hacia la izquierda, al lado del patio y otro en el gimnasio y el de mujeres esta en el primer piso en frente de preceptoria.<br>🔹Presione 1 para volver al menu.',0,true),
('48','Preceptoria','Hay una preceptoria en la esquina de el primer y segundo piso, una preceptoria de quimica en el pasillo interior del primer piso, junto a la sala de proyecciones y la preceptoria de taller en la planta baja, ubicada bajando las escaleras que estan al lado de la entrada principal.<br>🔹Presione 1 para volver al menu.',0,true),
('49','Biblioteca','La biblioteca se ubica en la planta baja, a la izquierda de la entrada ¿Te gustaria leer un libro en especifico?.<br>🔹Presiona 1 para volver al menu.',0,true),
('50','Sala de proyecciones','La sala de proyecciones se encuentra en el pasillo interior(al fondo) en el primer piso junto a la preceptoria de quimica y los laboratorio. en ella se pueden mirar peliculas, documentales o alguna charla en especifico.<br>🔹Presiona 1 para volver al menu.',0,true),
('51','Laboratorios','Los laboratorios de quimica se encuentran, dos en el primer piso en el pasillo interno, y otro en la planta baja al lado de la biblioteca, ¡hora de hacer experimentos! y los de informatica estan todos en el segundo piso al lado de preceptoria.<br>🔹Presiona 1 para volver al menu.',0,true),
('52','Direccion','La sala de direccion se encuentra en la planta baja en el pasillo que esta al lado del ascensor, tambien esta la secretaria, la vicedireccion, etc.<br>🔹Presione 1 para volver al menu.',0,true),
...
('54','Gimnasio','El gimnasio queda arriba del todo, subiendo las escaleras que estan al fondo del zoom. Mi deporte favorito es el futbol aunque no lo pueda jugar, es apasionante.<br>🔹Presione 1 para volver al menu.',0,true),
('55','Fundicion','La sala de fundicion se ubica bajando las escaleras que se encuentran al fondo del zoom, junto a fundicion esta carpinteria y construccion. Aqui se funden metales y se crean piezas de metal que los alumnos se pueden llevar, solo esta en 1° año.<br>🔹Presione 1 para volver al menu.',0,true),
('56','Torneria','Torneria se encuentra subiendo las escaleras al final del patio interior, junto a este esta hojalateria. Aqui los alumnos usan el torno y como proyecto haran un bate de baseball, ¿sabias que antes hacian un cañon en vez de un bate?.<br>🔹Presiona 1 para volver al menu.',0,true),
('57','Carpinteria','Carpinteria se encuentra bajando las escaleras en la zona de taller, esta al lado de construccion y fundicion. Aqui los chicos y chicas de 1°año van a poder crear un guarda llaves, una percha y con suerte una tabla de picar, en 2°año van a hacer un banco ¡que emocionante!<br>🔹Presione 1 para volver al menu.',0,true),
('58','Hojalateria','Hojalateria se encuentra junto a torneria subiendo las escaleras de taller. Aqui los alumnos en 1°año trabajan haciendo una palita que se pueden llevar a casa, eso si se va a oxidar con los años, jaja y en 2°año van a crear una cajita de herramientas ¡que divertido!<br>🔹Presione 1 para volver al menu.',0,true),
('59','Electricidad','La sala de electicidad queda subiendo las escaleras que se encuentran al fondo del zoom. Aqui las chicos y los chicos van a aprender teoria sobre la electricidad y a conectar cables, hacer funcionar focos y teclas y mucho mas, ¡electrizante!<br>🔹Presione 1 para volver al menu.',0,true),
('60','Salones','Los salones de dibujo tecnico estan en el ultimo piso, a ellos se pueden acceder suubiendo las escaleras del sector de teoria. Aqui trabajaran en mesas de dibujo haciendo planos junto a sus escuadras y su regla T.<br>🔹Presiona 1 para volver al menu.',0,true),
-- test
('5','test1','Listo para empezar el test orientacional, son 5 preguntas, completalo hasta el final:<br>¿Qué preferís hacer en tu tiempo libre?<br>a🔹Investigar, experimentar o probar cosas nuevas.<br>b🔹Armar o desarmar objetos para ver cómo funcionan.<br>c🔹Resolver acertijos, juegos de lógica o problemas.<br>d🔹Probar nuevas apps o explorar la computadora.<br>e🔹Dibujar, diseñar o planear cómo se construyen cosas.<br>f🔹Usar herramientas, cables o motores.',0,true),
('6','test2','En un grupo de trabajo, ¿qué rol solés tomar?<br>a🔹Probar ideas y asegurarme de que funcionen.<br>b🔹Encargarme de la parte práctica.<br>c🔹Ordenar la información y proponer soluciones lógicas.<br>d🔹Resolver problemas cuando alguien tiene dificultades con la compu.<br>e🔹Coordinar y organizar el plan de trabajo.<br>f🔹Manejar las máquinas, herramientas o sistemas.',0,true),
('7','test3','¿Con qué escenario te identificás más a futuro?<br>a🔹Creando o descubriendo algo que ayude a los demás.<br>b🔹Trabajando con autos, motos o motores.<br>c🔹Diseñando programas, apps o videojuegos.<br>d🔹Rodeado de computadoras, redes y sistemas tecnológicos.<br>e🔹Dirigiendo proyectos de construcción o infraestructura.<br>f🔹Manteniendo y mejorando equipos y sistemas.',0,true),
('8','test4','¿Qué taller o materia te ha gustado más por ahora?<br>a🔹Química, física y sus laboratorios.<br>b🔹Electricidad.<br>c🔹Taller de informática y matemáticas.<br>d🔹Taller de informática.<br>e🔹Dibujo técnico.<br>f🔹Tornería, hojalatería.',0,true),
('9','test5','¿Qué frase se acerca más a tu personalidad?<br>a🔹Me interesa experimentar con materiales y procesos para entender cómo y por qué cambian.<br>b🔹Me apasiona lo práctico y resolver problemas con mis manos.<br>c🔹Disfruto pensar de manera lógica y encontrar soluciones paso a paso.<br>d🔹Siempre quiero aprender lo último en tecnología y ayudar a otros con ella.<br>e🔹Tengo visión para organizar y dar forma a proyectos grandes.<br>f🔹Me gusta manipular herramientas, aparatos o sistemas para hacerlos funcionar mejor.',0,true),
-- menu
('menu','catalogo','El menu que tenemos es: <br>2🔹Orientaciones de la escuela. <br>3🔹Ubicaciones de la escuela. <br>4🔹Info. de la escuela <br>5🔹Test vocacional.',0,true),
('1','menu','El menu que tenemos es: <br>2🔹Orientaciones de la escuela. <br>3🔹Ubicaciones de la escuela. <br>4🔹Info. de la escuela <br>5🔹Test vocacional.',0,true);
